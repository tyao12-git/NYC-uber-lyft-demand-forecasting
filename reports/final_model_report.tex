...
of determination ($R^2$) of 0.9504. Model performance remains
...
16.49\% and an underprediction rate of 81.39\%.
...
\begin{table}[H]
\centering
\caption{Forecasting Error by Demand Level}
\resizebox{\textwidth}{!}{
...
\midrule
0--5
& 79,204 & 2.775 & 4.190 & 1.950 & 70.25\% \\

5--10
& 61,556 & 7.951 & 9.250 & 2.974 & 37.41\% \\

10--50
& 305,179 & 27.377 & 29.031 & 5.844 & 21.35\% \\

50--100
& 149,991 & 71.503 & 71.996 & 9.204 & 12.87\% \\

100--200
& 91,639 & 139.016 & 135.484 & 15.430 & 11.10\% \\

200--500
& 30,531 & 273.332 & 257.435 & 31.643 & 11.58\% \\

500+
& 1,961 & 634.995 & 550.017 & 104.712 & 16.49\% \\
\bottomrule
\end{tabular}
}
\end{table}
...
Extreme demand above 500 trips presents a different problem. The
average actual demand is approximately 635 trips, while the average
prediction is approximately 550 trips. Therefore, the remaining
error in this category reflects a meaningful systematic
underprediction rather than merely a denominator effect.
...
For demand above 500 trips, approximately 81.39\% of observations
are underpredicted. This indicates that extreme demand remains the
...
\begin{table}[H]
\centering
\caption{Performance for Demand Above 500 Trips}
\begin{tabular}{lr}
\toprule
Statistic & Value \\
\midrule
Observations & 1,961 \\
Average Actual Demand & 634.995 \\
Average Prediction & 550.017 \\
Average Residual & 84.978 \\
MAE & 104.712 \\
NMAE & 16.49\% \\
Underprediction Rate & 81.39\% \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Selected Zones with Demand Above 500 Trips}
\resizebox{\textwidth}{!}{
\begin{tabular}{lrrrrr}
\toprule
Pickup Zone &
...
\midrule
LaGuardia Airport
& 597 & 667.74 & 604.21 & 63.53 & 105.30 \\

JFK Airport
& 195 & 602.29 & 543.62 & 58.67 & 73.15 \\

Midtown Center
& 139 & 701.17 & 620.10 & 81.06 & 91.55 \\

East Village
& 134 & 719.54 & 613.15 & 106.39 & 129.50 \\

Lower East Side
& 101 & 684.72 & 582.99 & 101.74 & 119.11 \\

TriBeCa/Civic Center
& 82 & 567.04 & 453.74 & 113.30 & 113.30 \\

Union Sq
& 72 & 554.67 & 476.07 & 78.60 & 79.27 \\

West Chelsea/Hudson Yards
& 70 & 587.94 & 485.08 & 102.86 & 104.65 \\

Williamsburg (North Side)
& 69 & 595.99 & 518.12 & 77.87 & 87.61 \\

Crown Heights North
& 69 & 578.29 & 479.91 & 98.38 & 100.48 \\
\bottomrule
\end{tabular}
}
\end{table}
...
normal-demand observations. Only 1,961 validation observations exceed
...
bias but does not eliminate it. The remaining 81.39\% underprediction
...
The final model demonstrates strong overall forecasting performance, but systematic underprediction remains during extreme-demand periods.
 In particular, demand above 500 trips is underpredicted in approximately 81.39\% of observations. However, these extreme-demand observations
