...
\title{Business Inisghts and how I view my Model}
\author{Tommy Yao}
...
\begin{abstract}
In this short document,I will  provide specific business/strategic insights that can be derived from the final model. 
Admittedly, My final model do have some undeprediction problems for high-demand observations, however, it is better 
than the overprediction of the high-demand observations, and I will explain the potential reasons and opportunity cost 
for each of them. I will also include specific suggestions for companies make deliberate decisions for NYC ride demand.
\end{abstract}
